 ...
 */
public class FeatureStoreJCacheTestRICache extends FeatureStoreTestSupport {
   
    /** {@inheritDoc} */
    @Override
    protected FeatureStore initStore() {
        FeatureStoreJCache riCacheStore = new FeatureStoreJCache(RICachingProvider.class.getName());
        riCacheStore.importFeaturesFromXmlFile("ff4j.xml");
        return riCacheStore;
    }
