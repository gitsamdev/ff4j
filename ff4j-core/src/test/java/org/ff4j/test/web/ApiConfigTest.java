...
public class ApiConfigTest {
    ...
    public void testApiConfig() {
        ...
        apc1.setApiKeys(Util.setOf("1", "2"));apc1.getApiKeys();
        ...
        apc1.getWebContext();
        apc1.getContextPath();
        apc1.createApiKey("key", true, true, Util.setOf("USER", "ADMIN"));
        apc1.createUser("john", "tiger", true, true, Util.setOf("USER", "ADMIN"));
